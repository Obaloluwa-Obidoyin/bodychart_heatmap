...
<path id="head" d="M69 0L63 4V14H60.5V19.5C61.3333 20 63 21.2 63 22V30L69 
34H79L84.5 30V22L87.5 19.5V14H84.5V4L79 0H69Z" fill="${defaultColor()}"/>
// 
<path id="neck" d="M84.5 39.5V34L78 39.5V47H95.5L84.5 39.5Z" fill="${fillSvg("neck")}"/>
<path id="neck" d="M65 40.5V35L67 34L71 39.5L71.5 47H54L65 40.5Z" fill="${fillSvg("neck")}"/>
<path id="chest" d="M71 73.5V55L57.5 50L51.5 63L47.5 67.5L61.5 75L71 73.5Z" 
fill="${fillSvg("chest")}"/>
<path id="chest" d="M77 54L86.5 50H92.5L98.5 64L102 66V68L85.5 75L77 73.5V54Z" fill="${fillSvg("chest")}"/>
<path id="shoulder" d="M100 62.5L95.5 51L100.5 51.5L109 63.5V68L100 62.5Z" fill="${fillSvg("shoulder")}"/>
<path id="shoulder" d="M113.5 57.5L109 51H102.5L109 60L111.5 66.5H113.5V57.5Z" fill="${fillSvg("shoulder")}"/>
<path id="shoulder" d="M48.5 62.5L53.5 51C51.8333 51 48.5 51.1 48.5 51.5C48.5 51.9 43.1667 59 40.5 62.5V67L48.5 62.5Z" fill="${fillSvg("shoulder")}"/>
<path id="shoulder" d="M36.5 57V67L47 51H40.5L36.5 57Z" fill="${fillSvg("shoulder")}"/>
...
fill="${fillSvg("arm")}"/>
<path id="abs" d="M50 75.5V72L52 75.5H50Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M60 77L55.5 75.5L54.5 78L60 79.5V77Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M57 92L49.5 82.5V78.5L51.5 78L52 80L57.5 86.5L57 92Z" fill=""/>
<path id="abs" d="M52.5 79.5V78L59 81L58 86L52.5 79.5Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M49.5 93.5V86.5L57.5 96V101H55.5L49.5 93.5Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M59.5 105L53 102.5L52 120.5L62 127.5V125L60.5 121.5L59.5 105Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M96 102.5L89.5 106L89 121L87.5 125V127.5H89.5L97.5 121.5L96 102.5Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M92.5 101V95L96 92L100.5 86.5L99 95L92.5 101Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M93 92.5L92.5 86.5L97.5 81V78L100.5 78.5V82.5L93 92.5Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M96 78L90.5 81.5V86L92 85.5L96 81.5V78Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M93 75.5L89.5 78L95.5 77.5L96 75.5H93Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M100.5 75.5L97.5 72V76L100.5 75.5Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M69 78.5L60.5 82.5L61 87.5H63.5L68.5 84L72 83.5V78L69 78.5Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M77.5 84V78.5H82V79L88 81.5V87.5H86L82.5 84H77.5Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M72 96V88.5L62 92V97.5L65 96H72Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M77.5 96V88.5L87.5 91V97.5L84.5 96H77.5Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M62 107V101L72 100.5V110L69 109L62 107Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M78 110L77.5 101H87.5V108L81.5 109L78 110Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M70.5 112L62 111L66 134L72 136L70.5 112Z" fill="${fillSvg("abs")}"/>
<path id="abs" d="M86 112H77.5L76.5 136L82.5 134L86 112Z" fill="${fillSvg("abs")}"/>
<path id="leg" d="M49.5 123.5L52.5 126L51 164.5L60 199L54.5 164.5V143.5L64.5 166L63.5 198L60 199H57.5L47.5 166L49.5 123.5Z" fill="${fillSvg("leg")}"/>
<path id="leg" d="M96 127L99 123.5L100.5 166L91.5 199H88.5H86L82.1556 169.206L82 168L80.5 162L93.5 131.5V142.5L82 168L82.1556 169.206L96 142.5L95 166L88.5 199L97.5 166L96 127Z" fill="${fillSvg("leg")}"/>
<path id="leg" d="M56 142.5V131.5L60 142.5L68 162V168L56 142.5Z" fill="${fillSvg("leg")}"/>
<path id="leg" d="M73.5 189L68 171.5L65.5 200L69.5 201.5L73.5 189Z" fill="${fillSvg("leg")}"/>
<path id="leg" d="M76.5 189L80.5 171.5L82.1556 200L78.5 201.5L76.5 189Z" fill="${fillSvg("leg")}"/>
<path id="leg" d="M63.5 229.5L57.5 216.5L53.5 238.5L63.5 270.5L68 272.5L63.5 254V229.5Z" fill="${fillSvg("leg")}"/>
<path id="leg" d="M68 261V224L72.5 229.5L71 246L69.5 266.5L68 261Z" fill="${fillSvg("leg")}"/>
<path id="leg" d="M78.5 242.5V224L82.1556 231.5L83 248.5L80 266.5V247L78.5 242.5Z" fill="${fillSvg("leg")}"/>
<path id="leg" d="M86 226.5L91.5 216.5L95 238.5L86 269.5L83 272.5L80 270.5L86 248.5V226.5Z" fill="${fillSvg("leg")}"/>
